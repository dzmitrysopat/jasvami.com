...
<head>
    ...
    <title>Изолированность личности</title>
...
<body class="body_hide">
    ...
    <main class="main" id="main">
        <article class="site-info element-animation" id="test-preview">
            <section class="psy-info">
                <h1 class="site-name">Экспресс-диагностика уровня социальной изолированности личности</h1>
                <p class="information">
                    Вам предлагается ряд утверждений. Рассмотрите последовательно каждое и оцените с точки зрения частоты их проявления в вашей жизни при помощи четырех вариантов ответов:
                    <br><br>
                    «Часто», «Иногда», «Редко», «Никогда»
                    </p>
                    <a href="#" class="green-btn btn" id="testBtn" onclick="showTest()">Начать</a>
            </section>
                <img src="../../img/tests/isolation-preview-animate.svg" alt="Моё фото" class="test-photo">
        </article>
    ...
    <script src="../../script/test05.js"></script>
