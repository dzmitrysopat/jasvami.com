...
function showResults (){
    ...
    if (score <= 7){
        title = 'Ваш результат:';
        message = 'У Вас не наблюдается достоверно выраженных симптомов тревоги <br><br>';
    } else if (score >= 8 && score <= 10){
        title = 'Ваш результат:';
        message = 'У Вас наблюдается субклинически выраженная тревога <br><br>';
    } else if (score >= 11){
        title = 'Ваш результат:';
        message = 'У Вас клинически выраженная тревога <br><br>';
    }
